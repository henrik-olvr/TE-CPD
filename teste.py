...
# Funçao que atua de forma paralela
def executa_funcoes(algoritmo):
    for tipo in ['R', 'O', 'I']:
        if tipo == 'R':
            array = list(a0)
        elif tipo == 'O':
...
for elementos in TAM_ARRAYS_TESTE:
    ...
    # chamada da funçao de forma paralela
    Parallel(n_jobs=2)(delayed(executa_funcoes)(algoritmo) for algoritmo in FUNCOES)
